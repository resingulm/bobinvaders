...
const PLAYER_WIDTH: number = 40;
const PLAYER_HEIGHT: number = 30;
const PLAYER_SPEED: number = 5;
const BULLET_WIDTH: number = 4;
const BULLET_HEIGHT: number = 15;
const BULLET_SPEED: number = 7;
const ALIEN_WIDTH: number = 40;
const ALIEN_HEIGHT: number = 30;
const ALIEN_ROWS: number = 5;
const ALIEN_COLS: number = 11;
const ALIEN_SPACING_X: number = 60;
const ALIEN_SPACING_Y: number = 50;
const ALIEN_START_X: number = 50;
const ALIEN_START_Y: number = 50;
const ALIEN_SPEED: number = 1;
const ALIEN_DROP_DISTANCE: number = 20;
const ALIEN_SHOOT_CHANCE: number = 0.001;
...
const sounds: SoundEffects = {
    ...
    win: (): void => {
        ...
        try {
            // Victory fanfare
            const notes: number[] = [523.25, 659.25, 783.99, 1046.50]; // C5, E5, G5, C6
...
let keys: KeyMap = {};
let alienDirection: number = 1;
let alienSpeed: number = ALIEN_SPEED;
...
function update(): void {
    ...
    playerBullets = playerBullets.filter((bullet: Bullet) => {
        bullet.update();
        return !bullet.isOffScreen();
    });
    
    // Update alien bullets
    alienBullets = alienBullets.filter((bullet: Bullet) => {
        bullet.update();
        return !bullet.isOffScreen();
    });
    ...
    // Check win condition
    if (aliens.every((alien: Alien) => !alien.alive)) {
...
function updateAliens(): void {
    ...
    const aliveCount = aliens.filter((a: Alien) => a.alive).length;
...
function render(): void {
    ...
    // Draw aliens
    aliens.forEach((alien: Alien) => alien.draw());
    
    // Draw bullets
    playerBullets.forEach((bullet: Bullet) => bullet.draw());
    alienBullets.forEach((bullet: Bullet) => bullet.draw());
}
